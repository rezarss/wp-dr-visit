      ...
      <div class="border border2 rounded p-2 mb-3">
        ...
        <div class="row d-flex justify-content-start mx-4">
          ...
          <div class="col-md-2 col-sm-12 my-2">
            <label class="form-label inp-label">شماره تماس</label>
            <input type="text" class="form-control" name="drs_clinic_phone" id="clinic-phone-<?= $doctor->ID ?>" value="<?= $dr_shift_setting->clinic_phone ?>" aria-describedby="clinic-phone-help">
          </div>
          <div class="col-md-2 col-sm-12 my-2">
                    ...
                    <div>
                      <div class="row d-flex justify-content-center my-3">
                        ...
                        <div class="col-md-2 col-sm-12">
                          <label class="form-label inp-label">phone</label>
                          <input type="text" id="<?= $get_shift_schedule->phone ?>-shift<?= $i ?>-phone-<?= $get_shift_schedule->doctor_id ?>" name="<?= $get_shift_schedule->shift_type ?>_shift<?= $i ?>_phone_<?= $get_shift_schedule->doctor_id ?>" value="<?= $get_shifts->shifts[$i - 1]->shift_phone ?>" class="inp-shift">
                        </div>
                        <div class="col-md-2 col-sm-12">
                          <label class="form-label inp-label">latitude</label>
                    ...
                    <div class="row d-flex justify-content-center my-3">
                      ...
                      <div>
                        <div class="row d-flex justify-content-center my-3">
                          ...
                          <div class="col-md-2 col-sm-12">
                            <label class="form-label inp-label">phone</label>
                            <input type="text" id="<?= $get_shift_schedule->shift_type . '-' . $key ?>-shift<?= $i ?>-phone-<?= $get_shift_schedule->doctor_id ?>" name="<?= $get_shift_schedule->shift_type . '_' . $key ?>_shift<?= $i ?>_phone_<?= $get_shift_schedule->doctor_id ?>" value="<?= $get_shifts->shifts[$i - 1]->shift_phone ?>" class="inp-shift">
                          </div>
                          <div class="col-md-2 col-sm-12">
                            <label class="form-label inp-label">latitude</label>
                      ...
                      <div class="row d-flex justify-content-center my-3">
                        ...
                        <div>
                          <div class="row d-flex justify-content-center my-3">
                            ...
                            <div class="col-md-2 col-sm-12">
                              <label class="form-label inp-label">phone</label>
                              <input type="text" id="date-<?= $dsh->shift_time ?>-shift<?= $i ?>-phone-<?= $doctor->ID ?>" name="date_<?= str_replace("-", "_", $dsh->shift_time); ?>_shift<?= $i ?>_phone_<?= $doctor->ID ?>" value="<?= $get_shifts->shifts[$i - 1]->shift_phone ?>" class="inp-shift">
                            </div>
                            <div class="col-md-2 col-sm-12">
                              <label class="form-label inp-label">latitude</label>
